...
class DefaultIndexOperations extends AbstractDefaultIndexOperations implements IndexOperations {
	...
	public DefaultIndexOperations(TransportClient client, ElasticsearchConverter elasticsearchConverter) {
	...
	public boolean createIndex(String indexName, Object settings) {
		CreateIndexRequest request = createIndexRequest(indexName, settings);
		try {
			return client.admin().indices().create(request).isAcknowledged();
		} catch (IOException e) {
	...
	public boolean indexExists(String indexName) {
		...
		try {
			return client.admin().indices().exists(request).i;
		} catch (IOException e) {
